...
function Pizza() { 
  ...
  return (
    <div className="container text-center">
      <Card border="warning" className="text-center m-3" style={{ width: '25rem' }}>
        <Card.Img variant="top" src={dataPizza.img} className="img-fluid" alt={dataPizza.name} />
        <Card.Body>
         ...
         <Card.Subtitle className="mb-2 text-muted">
          ...
          <span>
            ...
            </Spinner> {dataPizza.ingredients.join(" , ")}
            </ListGroup.Item>
               </ListGroup>
        </Card.Subtitle>
        </Card.Body>
        <hr />
        <Card.Title>Precio: $<span>{dataPizza.price}</span></Card.Title>
        <Card.Body className="d-flex justify-content-around">
          <Button variant="dark" href="#">Añadir </Button>
        </Card.Body>
      </Card>
    </div>
  );
